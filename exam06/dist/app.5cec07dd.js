...
},{"./news-detail-view":"src/pages/news-detail-view.ts","./news-feed-view":"src/pages/news-feed-view.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
var newsFeedView = new pages_1.NewsFeedView('root');
var newsDetailView = new pages_1.NewsDetailView('root');
router.setDefaultPage(newsFeedView);
router.addRouterPath('/page/', newsFeedView);
router.addRouterPath('/show/', newsDetailView);
router.route();
},{"./core/router":"src/core/router.ts","./pages":"src/pages/index.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
